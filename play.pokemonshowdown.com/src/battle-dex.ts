...
const CUSTOM_ABILITY_UPDATES: {[id: string]: AnyObject} = {
	...
	ancientbloom: { name: "Ancient Bloom" },
	ange: { name: "Ange" },
	apexcleave: { name: "Apex Cleave" },
	...
	aurainstinct: { name: "Aura Instinct" },
	auramaster: { name: "Aura Master" },
	...
	bloomingsun: { name: "Blooming Sun" },
	bonewarrior: { name: "Bone Warrior" },
	bruteforce: { name: "Brute Force" },
	burningcrown: { name: "Burning Crown" },
	burningego: { name: "Burning Ego" },
	...
	corrosivedust: { name: "Corrosive Dust" },
	corrosivescale: { name: "Corrosive Scale" },
	crueltag: { name: "Cruel Tag" },
	crumblingshell: { name: "Crumbling Shell" },
	cursedkeepsake: { name: "Cursed Keepsake" },
	cursedmarionette: { name: "Cursed Marionette" },
	...
	fortressshell: { name: "Fortress Shell" },
	freezerburn: { name: "Freezer Burn" },
	frostsovereign: { name: "Frost Sovereign" },
	frozenfortress: { name: "Frozen Fortress" },
	furnaceengine: { name: "Furnace Engine" },
	grandmaster: { name: "Grandmaster" },
	heatcoil: { name: "Heat Coil" },
	heavenlychorus: { name: "Heavenly Chorus" },
	...
	mourningvessel: { name: "Mourning Vessel" },
	neutralization: { name: "Neutralization" },
	noseformation: { name: "Nose Formation" },
	...
	perfectforesight: { name: "Perfect Foresight" },
	phantomfist: { name: "Phantom Fist" },
	pollenbloom: { name: "Pollen Bloom" },
	powerdrill: { name: "Power Drill" },
	precision: { name: "Precision" },
	predator: { name: "Predator" },
	primaltactics: { name: "Primal Tactics" },
	prismscale: { name: "Prism Scale" },
	queensguard: { name: "Queen's Guard" },
	ragingcurrent: { name: "Raging Current" },
	...
	selfsufficient: { name: "Self Sufficient" },
	shadowcurrent: { name: "Shadow Current" },
	shadowguard: { name: "Shadow Guard" },
	shellprison: { name: "Shell Prison" },
	shelltrap: { name: "Shell Trap" },
	siegelauncher: { name: "Siege Launcher" },
	...
	stormcircuit: { name: "Storm Circuit" },
	stormfright: { name: "Storm Fright" },
	stormsovereign: { name: "Storm Sovereign" },
	streettyrant: { name: "Street Tyrant" },
	striker: { name: "Striker" },
	strikersmomentum: { name: "Striker's Momentum" },
	sunsovereign: { name: "Sun Sovereign" },
	surgeconduit: { name: "Surge Conduit" },
	...
	uncheckedassault: { name: "Unchecked Assault" },
	unleashedego: { name: "Unleashed Ego" },
	vanguard: { name: "Vanguard" },
	vendetta: { name: "Vendetta" },
	venombastion: { name: "Venom Bastion" },
	venomrush: { name: "Venom Rush" },
	verdantdrake: { name: "Verdant Drake" },
