...
var replaceAbilities=!!(customData.replaceAbilities||customData.requiredItem||customData.requiredAbility);
...
if((data==null?void 0:data.name)==='Gardevoir-Void')return true;
...
var CUSTOM_TEAMBUILDER_GMAX_SPRITE_MAX_HEIGHT=78;
...
var CUSTOM_TEAMBUILDER_BACKGROUND_POSITION_OVERRIDES={
...
var backgroundPositionOverride=CUSTOM_TEAMBUILDER_BACKGROUND_POSITION_OVERRIDES[id];
var position=backgroundPositionOverride==null?void 0:backgroundPositionOverride[spriteData.shiny?'shiny':'normal'];
if(position){
...
truedevotion:['falsedevotion','protean','technician'],
...
burningcrown:['intimidate','moldbreaker','whitesmoke','wildfirecore'],
...
var customCryUrl=speciesNameId==='sharpedomegay'?'audio/cries/sharpedo-megay.ogg':
...
var left=num%12*40;
var fainted=(_pokemon0=pokemon)!=null&&_pokemon0.fainted?";opacity:.3;filter:grayscale(100%) brightness(.5)":"";
...
id=species.id;
var customSpeciesData=(_CUSTOM_SPECIES$id5=CUSTOM_SPECIES[id])==null?void 0:_CUSTOM_SPECIES$id5.data;
